layui.define("view", function(e) {
    var a = layui.jquery,
        ...
        F = P.events = {
            ...
            setTheme: function(e) {
                var a = e.data("static.layuiadmin.lib.index");
                e.siblings(".layui-this").data("static.layuiadmin.lib.index");
    ...
    ! function() {
        ...
        e.siblings(".layui-nav-child")[0] && u.hasClass(C) && (P.sideFlexible("spread"), layer.close(e.data("static.layuiadmin.lib.index"))), P.tabsPage.type = "nav"
    ...
    o.on("click", z, function() {
        ...
        if (!e.parent().hasClass("layui-nav-item") || u.hasClass(C)) {
            ...
            e.data("static.layuiadmin.lib.index", l)
        }
    }).on("mouseleave", "*[lay-tips]", function() {
        layer.close(a(this).data("static.layuiadmin.lib.index"))
    });
